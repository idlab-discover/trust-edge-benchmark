...
while [ $counter -lt $total ]; do
    ...
    keylime_start_time=$(systemctl show -p ExecMainStartTimestampMonotonic --value keylime_agent.service)
    fledge_start_time=$(systemctl show -p ExecMainStartTimestampMonotonic --value feather.service)
    ...
    time_difference=$((fledge_start_time - keylime_start_time))
